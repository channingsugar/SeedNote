/* editorial-flow 自己的 token。不要和 editorial-page 共用。 */
(() => {
  const tokens = {
    aliases: {},
    colors: [
    ...
    editorial: [
      { id: 's-in', name: '区内', variable: '--s-in', value: '16px', kind: 'size' },
      { id: 's-stack', name: '换排', variable: '--s-stack', value: '40px', kind: 'size' },
      { id: 's-chapter', name: '换章', variable: '--s-chapter', value: '96px', kind: 'size' },
      { id: 't-h1', name: '章题', variable: '--t-h1', value: 'clamp(28px, 3.4vw, 40px)', kind: 'type' },
      { id: 't-h2', name: '小节', variable: '--t-h2', value: '20px', kind: 'type' },
      { id: 't-num', name: '数据', variable: '--t-num', value: 'clamp(36px, 4vw, 56px)', kind: 'type' },
      { id: 't-no', name: '编号', variable: '--t-no', value: '12px', kind: 'type' },
      { id: 't-no-lg', name: '大编号', variable: '--t-no-lg', value: 'clamp(28px, 3.2vw, 40px)', kind: 'type' },
      { id: 't-body', name: '正文', variable: '--t-body', value: '16px', kind: 'type' },
      { id: 't-aux', name: '辅助', variable: '--t-aux', value: '12px', kind: 'type' },
      { id: 'c-text', name: '正文', variable: '--c-text', value: '#1D1D1F', kind: 'color' },
      { id: 'c-text-2', name: '次级', variable: '--c-text-2', value: '#424245', kind: 'color' },
      { id: 'c-text-3', name: '三级', variable: '--c-text-3', value: '#6E6E73', kind: 'color' },
      { id: 'c-text-4', name: '四级', variable: '--c-text-4', value: '#86868B', kind: 'color' },
      { id: 'c-line', name: '线', variable: '--c-line', value: '#E5E5EA', kind: 'color' },
      { id: 'c-accent', name: '强调', variable: '--c-accent', value: '#0071E3', kind: 'color' },
      { id: 'c-pos', name: '表正向', variable: '--c-pos', value: '#00875A', kind: 'color' },
      { id: 'c-neg', name: '表负向', variable: '--c-neg', value: '#C81E1E', kind: 'color' },
      { id: 'rule', name: '强线', variable: '--rule', value: '1px', kind: 'size' },
      { id: 'rule-soft', name: '弱线', variable: '--rule-soft', value: '1px', kind: 'size' }
    ],
    spaces: [
  ...
  window.DesignSystemData = {
    version: 1,
    storageKey: 'editorial-flow-design-v1',
    clone(value) {
